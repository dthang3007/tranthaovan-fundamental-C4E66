...
for (let i = 0; i < arr; i++) {
    ...
    console.log(arr[i].locations);
    console.log(arr[i].jobSalary);
    arr[i].benefits.forEach((value) => {
        console.log(value.benefitIconName, value.benefitId, value.benefitName, value.benefitValue)
    })
